...
export const TIPOS = [
  ...
  'seguimiento_enviado',
  // Prepago (bloque A-0, 20/09): el servicio se cortó por falta de pago o de
  // conversaciones (el motivo va en `codigo`), volvió, y entró un pago. Un
  // corte solo observado no se escribe: para el comercio no existe.
