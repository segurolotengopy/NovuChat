...
function TableroComercio({ tenantId, esAdmin }: { tenantId: string; esAdmin: boolean }) {
  ...
  return (
    ...
    <div className="cuadricula">
      ...
      {/* GANA LA TARJETA DEL PREPAGO, y no la del estado de pago que traía la
          rama del diseño. No es un desempate arbitrario: `estadoPago` decía «al
          día» aunque el negocio se hubiera quedado sin conversaciones, que es
          justo el momento en que el comercio necesita enterarse. La corrección
          que traía la otra rama —no pintar el valor crudo de la base, y que el
          verde lo gane un estado conocido— ya está adentro de `lib/prepago`. */}
