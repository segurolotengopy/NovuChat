...
1. `${RUTA_ESTANDAR}/00-gobernanza/01-politica-cicd-devsecops.md` (fases, roles, excepciones, métricas DORA en la sección 9, tabla de mapeo v1 → v2).
2. `${RUTA_ESTANDAR}/00-gobernanza/03-ambientes-modos-y-aprobaciones.md` (requisitos de cada modo) y `04-matriz-herramientas-y-costos.md` (costos por modo).
3. `${RUTA_ESTANDAR}/01-seguridad/05-checklist-pase-a-produccion.md` (estructura del acta).
