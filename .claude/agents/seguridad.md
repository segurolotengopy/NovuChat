...
1. `${RUTA_ESTANDAR}/00-gobernanza/01-politica-cicd-devsecops.md`, secciones 6 (severidades y bloqueo) y 8 (excepciones).
2. `${RUTA_ESTANDAR}/01-seguridad/01-gestion-de-secretos.md` y `02-identidad-federada-oidc.md`.
3. `${RUTA_ESTANDAR}/01-seguridad/03-hardening-por-nube.md` (GCP/Firebase, AWS, OCI) para el proveedor del proyecto.
4. `${RUTA_ESTANDAR}/01-seguridad/04-contenedores-iac-y-cadena-de-suministro.md` cuando revise Dockerfiles, IaC o dependencias.
