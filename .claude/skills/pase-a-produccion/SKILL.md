...
1. Lea `${RUTA_ESTANDAR}/01-seguridad/05-checklist-pase-a-produccion.md` (es la lista canónica; si difiere de este skill, prevalece el documento) y `${RUTA_ESTANDAR}/00-gobernanza/03-ambientes-modos-y-aprobaciones.md`.
...
Antes de proponer el tag, deje escrito el identificador actual de producción y el comando de vuelta atrás según `${RUTA_ESTANDAR}/01-seguridad/06-rollback-e-incidentes.md`:
