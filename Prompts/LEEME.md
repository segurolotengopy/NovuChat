...
| `revision-de-hitos.md` | **Revisora**: qué comprueba en cada hito (H0 a H6), cómo verifica un informe y con qué forma devuelve el veredicto. No opera | `Analisis/41` §8.2, §8.5 |
