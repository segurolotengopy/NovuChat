...
| `rearquitectura-por-capas.md` | **Operadora**: las cinco zonas (core, central, plataforma, módulos, tenants), fases F-1 a F6 más el estándar (E) y el staging (S), con agentes por zona, regla de integración y protocolo de hitos. Absorbe las nueve sesiones abiertas el 25/09. **Reorientado el 26/09** (`Analisis/41` §6.3): F1b, F3 partida en F3a y F3b, H4 por cliente | `Analisis/41` (§5 inventario, §7 fases, §8 agentes e hitos, §12 clientes), `Analisis/20`, `35`, `39` |
| `operacion-de-clientes.md` | **Por cliente**: el ciclo de vida de ocho etapas, el análisis de solicitud con tres opciones «así se puede», el congelamiento de código a medida mientras F2 y F3 estén en obra, y el estado de cada instancia al 25/09 | `Analisis/41` §12, `13`, `25`, `30`, `38`; runbooks de alta y de pase |
| `revision-de-hitos.md` | **Revisora**: qué comprueba en cada hito (H0 a H6, con H1b, H3a, H3b y H4 por cliente desde el 26/09), cómo verifica un informe y con qué forma devuelve el veredicto. No opera | `Analisis/41` §8.2, §8.5 |
| `medicion-origen-anuncio.md` | Medir qué fracción del tráfico nace de un anuncio de clic a WhatsApp (ventana de punto de entrada gratuito). **Retoma la rama `medicion/origen-del-anuncio`, con el trabajo hecho y sin fusionar** | `Analisis/38` §2, `Analisis/39` |
| `traspaso-chat-interno.md` | **Retoma** del traspaso del chat interno de NovuChat al portafolio de Silvana y al número nuevo, con app propia; Tech Provider (AAB1) queda para después; empieza por el error de arquitectura que Andres detectó el 24/09 | `CLIENTES/NOVUCHAT/traspaso-tech-provider.md` (local), `ESTADO.md` 24/09, precedente de Platinum 21/09 |
